...
def Updates_DE():
  ...
  if Update_Starten_Frage == "y".lower():
    ...
    Updating_DE = subprocess.call(["yay", "-Syu", "--noconfirm", "--noprogressbar"], stdout=subprocess.DEVNULL)
...
def Updates_EN():
  ...
  if Update_Start_Question == "y".lower():
    ...
    Updating_EN = subprocess.call(["yay", "-Syu", "--noconfirm", "--noprogressbar"], stdout=subprocess.DEVNULL)
